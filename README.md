...
проигрыватели с озвучкой появляются по мере готовности этапов, а не в конце
прогона. Проигрывателей в запасе двенадцать, куски сверх этого не показываются.

Ход прогона идёт отдельным списком: каждый вызов инструмента с его аргументом и
исход вызова - выполнен, провален или отклонён по бюджету.
