...
class ResearchNotes(BaseModel):
    ...
    summary: str = Field(
        description = (
            "О чём собранный материал и в каком порядке его логично излагать, "
            "без пересказа самих фактов"
        )
    )
    ...
    details: list[str] = Field(
        description = (
            "Наглядные важные подробности из материалов, например: "
            "цвета, звуки, запахи, размеры, сравнения"
        )
    )
    gaps: list[str] = Field(
