...
журнал: все настройки приходят объектом WebConfig, а сообщения печатаются через
print. Перенос в другой проект - копирование папки вместе с соседним модулем
filecache.py, на котором держится кеш.
